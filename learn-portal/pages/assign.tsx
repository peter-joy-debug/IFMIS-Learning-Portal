...
const AssignPage = () => {
  ...
  return (
    ...
    <Grid>
        <Grid.Col span={12}>
        <Text fw={600} size='xl' style={{textAlign:'center', borderBottomLeftRadius:'100px', borderBottom:'1px solid lightblue',borderBottomRightRadius:'100px', paddingBottom:'1%'}}> Assign User To Ticket </Text>
        </Grid.Col>
